...
\item \emph{Quadratic Discriminant Analysis};
\item Modello Multinomiale;
\item Albero di Classificazione.
\end{enumerate}
Per l'analisi il dataset è stato splittato in training, validation e test. % nomi in italiano non li ricordo ora
\end{frame}
