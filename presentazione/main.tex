...
\end{center}
\begin{figure}[H]
\includegraphics[width=0.8\textwidth]{../figure/confusionMatrix-Mn-test.png}
\end{figure}
\end{column}%
\hfill%
\begin{column}{.5\textwidth}
...
\end{center}
\begin{figure}[H]
\includegraphics[width=0.8\textwidth]{../figure/confusionMatrix-QDA-penalizzata-test.png}
\end{figure}
\end{column}%
\end{columns}
\end{frame}
